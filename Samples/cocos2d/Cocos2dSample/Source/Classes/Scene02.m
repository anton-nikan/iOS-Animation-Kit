...
- (id)init
{
    if ((self = [super initWithIndex:2 description:@"Adding sounds in action points makes it more interesting"])) {
        CGSize ws = [CCDirector sharedDirector].winSize;
        
        NSDictionary *clip = [AKHelpers animationClipFromPlist:@"scene02-soundclip.plist"];
